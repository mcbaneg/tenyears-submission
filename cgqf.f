...
c modified to return value for g77 1/18/90 gcm
      DOUBLE PRECISION X
c     DOUBLE PRECISION X,Y
c     DOUBLE PRECISION ZERO,HALF,ONE,TWO
c     PARAMETER (ZERO=0.0D0,HALF=0.5D0,ONE=1.0D0,TWO=2.0D0)
CS    PARAMETER (ZERO=0.0E0,HALF=0.5E0,ONE=1.0E0,TWO=2.0E0)
C
c     Y=ONE
c10    IF (Y+ONE.NE.ONE) THEN
c         X=Y
c         Y=Y/TWO
c                                                GOTO 10
c      END IF
...
c      DATA XBIG, XMININ, EPS /171.489D0,1.113D-308,1.110D-16/
c  line modified from above to generate compile on DVF
c     gcm 5 may 2009; 
      DATA XBIG, XMININ, EPS /171.489D0,2.5D-308,1.110D-16/
      DATA XINF /1.79769313D308/
C----------------------------------------------------------------------
